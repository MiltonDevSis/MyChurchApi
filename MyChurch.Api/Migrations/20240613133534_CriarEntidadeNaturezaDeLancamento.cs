    ...
    public partial class CriarEntidadeNaturezaDeLancamento : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_natirezadelancamento", x => x.Id);
                    table.ForeignKey(
                        name: "FK_natirezadelancamento_usuario_IdUsuario",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_natirezadelancamento_IdUsuario",
                table: "natirezadelancamento",
                column: "IdUsuario");
        }
